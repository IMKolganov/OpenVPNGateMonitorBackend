...
namespace OpenVPNGateMonitor.DataBase.Migrations
{
    ...
    [Migration("20250228000412_Settings_Seeds")]
    partial class Settings_Seeds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenVPNGateMonitor.Models.Setting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreateDate = new DateTime(2025, 2, 28, 0, 4, 12, 335, DateTimeKind.Utc).AddTicks(8156),
                            IntValue = 120,
                            Key = "OpenVPN_Polling_Interval",
                            LastUpdate = new DateTime(2025, 2, 28, 0, 4, 12, 335, DateTimeKind.Utc).AddTicks(8053),
                            ValueType = "int"
                        },
                        new
                        {
                            Id = -2,
                            CreateDate = new DateTime(2025, 2, 28, 0, 4, 12, 335, DateTimeKind.Utc).AddTicks(8349),
                            Key = "OpenVPN_Polling_Interval_Type",
                            LastUpdate = new DateTime(2025, 2, 28, 0, 4, 12, 335, DateTimeKind.Utc).AddTicks(8348),
                            StringValue = "int",
                            ValueType = "string"
                        },
                        new
                        {
                            Id = -3,
                            CreateDate = new DateTime(2025, 2, 28, 0, 4, 12, 335, DateTimeKind.Utc).AddTicks(8351),
                            Key = "OpenVPN_Polling_Interval_Unit",
                            LastUpdate = new DateTime(2025, 2, 28, 0, 4, 12, 335, DateTimeKind.Utc).AddTicks(8351),
                            StringValue = "seconds",
                            ValueType = "string"
                        },
                        new
                        {
                            Id = -4,
                            CreateDate = new DateTime(2025, 2, 28, 0, 4, 12, 335, DateTimeKind.Utc).AddTicks(8353),
                            Key = "OpenVPN_Polling_Interval_Unit_Type",
                            LastUpdate = new DateTime(2025, 2, 28, 0, 4, 12, 335, DateTimeKind.Utc).AddTicks(8353),
                            StringValue = "string",
                            ValueType = "string"
                        });
                });
